...
const Dice = (mx, mn) => Math.floor(Math.random() * mx + mn);
...
const SplitMe = str => str.trim().split(/\s+/);
...
//let str = 'Miao';
//let DeleteOne = x => (x === 5 ? str.slice(1) : str.substring(0, 3));

//console.log(DeleteOne(4, str));
...
let IsThisAnEmail = x =>
  x.length === 6 ? "it's a valid email" : "it's not a valid email";

console.log(IsThisAnEmail('ciaone'));

/* Ex.7
   Write the function WhatDayIsIt that should return the day of the week
*/

/*function WhatDayIsIt(d, x) {
...
console.log('returns Fri:', WhatDayIsIt('Wed', 2));
console.log('returns Thu:', WhatDayIsIt('Sat', 5));*/
